...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U1RX, INPUT_PIN_RPG8 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U1CTS, INPUT_PIN_RPB8 );

    /* PPS Output Remapping */
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO1, OUTPUT_PIN_RPE5 );
    ...
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U1RTS, OUTPUT_PIN_RPB6 );
