...
//15668417/1055354/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TCA9536DGKR" (originalName "TCA9536DGKR")
	...
	(compDef "TCA9536DGKR" (originalName "TCA9536DGKR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "P0") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "P1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "P2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "SDA") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "SCL") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "P3 / __INT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TCA9536DGKR"))
		...
		(attr "Manufacturer_Part_Number" "TCA9536DGKR")
		(attr "Mouser Part Number" "595-TCA9536DGKR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TCA9536DGKR?qs=doiCPypUmgHJyc0NMelqCA%3D%3D")
		(attr "Arrow Part Number" "TCA9536DGKR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tca9536dgkr/texas-instruments?region=nac")
		(attr "Description" "TCA9536DGKR")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tca9536.pdf?ts=1641403369587&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTCA9536")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TCA9536DGKR.stp")
