...
(library Library_1
	...
	(compDef "TCA9536DGKR" (originalName "TCA9536DGKR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "P2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "5" (pinName "P3 / __INT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.ti.com/lit/ds/symlink/tca9536.pdf?ts=1641403369587&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTCA9536")
		(attr "Height" "1.1 mm")
	)
