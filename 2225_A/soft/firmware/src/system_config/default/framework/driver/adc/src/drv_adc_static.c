...
void DRV_ADC_Initialize(void)
{
    ...
    PLIB_ADC_ConversionClockSet(DRV_ADC_ID_1, SYS_CLK_CONFIG_PRIMARY_XTAL, 4000000);
    ...
    /* Buffer Mode */
    PLIB_ADC_ResultBufferModeSelect(DRV_ADC_ID_1, ADC_BUFFER_MODE_TWO_8WORD_BUFFERS);
